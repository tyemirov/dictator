...
def synthesise(
    ...
    ``{"text": chunk, "start": float, "end": float}``.
    """
    ...
    for idx, chunk in enumerate(chunks):
        ...
        segments.append({"text": chunk, "start": elapsed, "end": elapsed + dur})
        elapsed += dur
...
def main() -> None:
    ...
    parser.add_argument(
        "--speech",
        help="write JSON timeline of text chunks and their start/end times",
    )
