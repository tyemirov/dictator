...
| Symptom                             | Fix                                                                                                                                                                                                                                                                                             |
|-------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *Model download looks stuck at 0 %* | Some networks block OpenAI’s model host. </br>Run `curl -L https://openaipublic.azureedge.net/main/whisper/models/large-v3.pt -o /dev/null` – if that stalls, use a VPN or pre-download models on another connection and copy them to `~/.cache/whisper` (Whisper) or `~/.cache/tts` (XTTS). |
